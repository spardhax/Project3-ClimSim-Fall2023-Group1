...
system("git clone https://github.com/leap-stc/ClimSim")

```


```{r, warning=FALSE,message=FALSE,RuntimeWarning=FALSE}
...
# Assuming these functions are available in R, or have been translated to equivalent R functions
